...
declare type BaseConfig = Pick<GraphQLOptions<Context<any>>, 'formatError' | 'debug' | 'rootValue' | 'validationRules' | 'formatResponse' | 'fieldResolver' | 'tracing' | 'dataSources' | 'cache'>;
