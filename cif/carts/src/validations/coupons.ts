...
const ERROR_TYPE = 'CouponError';

function postCoupon(args: any): Input {

  return new Validator<Coupon>(args, ERROR_TYPE)
    .setMapper(CouponMapper)
    .checkArguments()
...
function deleteCouponById(args: any): Input {
