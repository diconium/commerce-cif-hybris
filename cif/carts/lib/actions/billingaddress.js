...
const PostBillingAddressClient_1 = __importDefault(require("../clients/PostBillingAddressClient"));
const ERROR_TYPE = 'BillingAddressError';
function postBillingAddress(input) {
    return new commerce_cif_hybris_core_1.SequenceAction(input)
        .setClient(PostBillingAddressClient_1.default)
        .setErrorType(ERROR_TYPE)
        .activate();
}
exports.post = postBillingAddress;
