...
class DeleteCouponClient extends commerce_cif_hybris_clients_1.HttpClient {
    constructor(input) {
        super(input);
    }
    exec() {
        const { bearer, customerId, } = this.input.settings;
        const { id, couponId, } = this.input.parameters;
...
exports.default = DeleteCouponClient;
//# sourceMappingURL=DeleteCouponClient.js.map