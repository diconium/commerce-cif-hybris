...
class PostCartEntryClient extends commerce_cif_hybris_clients_1.HttpClient {
    constructor(input) {
        super(input);
    }
    exec() {
        const { bearer, customerId, } = this.input.settings;
        const { id, entry, } = this.input.parameters;
        if (entry) {
        ...
        return Promise.resolve(new commerce_cif_hybris_clients_1.CartModificationWsDTO());
    }
}
exports.default = PostCartEntryClient;
//# sourceMappingURL=PostCartEntryClient.js.map