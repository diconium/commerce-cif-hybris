...
class PostShippingMethodClient extends commerce_cif_hybris_clients_1.HttpClient {
    constructor(input) {
        super(input);
    }
    exec() {
        const { bearer, customerId, } = this.input.settings;
        const { id, deliveryModeId, } = this.input.parameters;
...
exports.default = PostShippingMethodClient;
//# sourceMappingURL=PostShippingMethodClient.js.map