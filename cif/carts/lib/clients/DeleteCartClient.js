...
class DeleteCartClient extends commerce_cif_hybris_clients_1.HttpClient {
    constructor(input) {
        super(input);
    }
    exec() {
        ...
        return this.delete(`/users/${customerId}/carts/${id}`, { bearer })
            .then(() => undefined) // new CartWsDTO())
            .catch(errorOutput => Promise.reject(errorOutput));
    }
}
exports.default = DeleteCartClient;
//# sourceMappingURL=DeleteCartClient.js.map