...
class DeletePaymentClient extends commerce_cif_hybris_clients_1.HttpClient {
    constructor(input) {
        super(input);
    }
    exec() {
        const { bearer, customerId, } = this.input.settings;
        const { paymentId, } = this.input.parameters;
...
exports.default = DeletePaymentClient;
//# sourceMappingURL=DeletePaymentClient.js.map