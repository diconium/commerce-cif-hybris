...
class CouponMapper extends commerce_cif_hybris_core_1.Mapper {
    constructor(settings) {
        super(settings);
    }
    mapFromInputArgsToActionParameters(mappable) {
        const { id, code, couponId, } = mappable;
    ...
    mapToEntity(dto, entity) {
        const { code, voucherCode, } = dto;
        return new commerce_cif_model_1.Coupon.Builder()
            .withId(code)
            .withCode(voucherCode)
            .build();
    }
}
exports.default = CouponMapper;
