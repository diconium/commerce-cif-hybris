...
class PaymentMethodMapper extends commerce_cif_hybris_core_1.Mapper {
    ...
    mapToEntity(dto, entity) {
        ...
        return new commerce_cif_model_1.PaymentMethod.Builder()
            .withId(id)
            .withName(cardType.name)
            .build();
    }
}
exports.default = PaymentMethodMapper;
//# sourceMappingURL=PaymentMethodMapper.js.map