...
export default class GetCategoryBySlugClient extends HttpClient {
  ...
  exec(): Promise<CategoryHierarchyWsDTO> {
    ...
    // TODO: confirm hybris URL
    return this.get(`/catalogs/${catalogId}/${catalogVersionId}/categories/slug/${slug}`, { queryParameters: { fields: 'FULL' } })
